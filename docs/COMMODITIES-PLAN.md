...
- **M1c, VPS (2026-09-24).** Node 24.21.0 from NodeSource; system user
  ...
  login. Still open for the M1 check: the founder's keys and Cloudflare steps,
  the browser look, and a deliberately failing commit.
